  ...
  return (
    <View style={styles.rect}>
      <View style={styles.rect2Stack}>
        <View style={activeIndex == 0 ? { ...styles.rect2, ...styles.active } : styles.rect2}>
          <TouchableOpacity style={styles.iconRow} onPress={() => setActiveIndex(0)}>
            <FontAwesomeIcon name="calendar-o" style={styles.icon} />
            <Text style={styles.daily}>DAILY</Text>
          </TouchableOpacity>
        </View>
        <View style={activeIndex == 1 ? { ...styles.rect3, ...styles.active } : styles.rect3}>
          <TouchableOpacity style={styles.icon2Row} onPress={() => setActiveIndex(1)}>
      ...
      <View style={styles.rect4}>
        <View style={styles.icon3Row}>
          <SimpleLineIconsIcon name="magnifier" style={styles.icon3} />
          <TextInput
              ...
              searchResults.length > 0 ? (
                searchResults.map((item) => (
                  <TouchableOpacity
                    ...
                    <EntypoIcon name="location-pin" size={30} color="#27aae1" />
