...
const initialListing = {
  ...
  spaceAvailable: {
    ...
    tuesday: { isActive: false, startHour: 9, startMinute: 10, endHour: 18, endMinute: 10 },
    wednesday: { isActive: false, startHour: 9, startMinute: 10, endHour: 18, endMinute: 10 },
    thursday: { isActive: false, startHour: 9, startMinute: 10, endHour: 18, endMinute: 10 },
    friday: { isActive: false, startHour: 9, startMinute: 10, endHour: 18, endMinute: 10 },
    saturday: { isActive: false, startHour: 9, startMinute: 10, endHour: 18, endMinute: 10 },
    sunday: { isActive: false, startHour: 9, startMinute: 10, endHour: 18, endMinute: 10 },
