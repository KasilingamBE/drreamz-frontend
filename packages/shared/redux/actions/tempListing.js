...
export const TEMP_LISTING_MOBILE_INITIAL = 'TEMP_LISTING_MOBILE_INITIAL';
export const UPDATE_TEMP_LISTING = 'UPDATE_TEMP_LISTING';
export const DELETE_TEMP_LISTING = 'DELETE_TEMP_LISTING';
export const TEMP_LISTING_UPDATE_LOCATIONDETAILS = 'TEMP_LISTING_UPDATE_LOCATIONDETAILS';
export const TEMP_LISTING_UPDATE_SPACEDETAILS = 'TEMP_LISTING_UPDATE_SPACEDETAILS';
export const TEMP_LISTING_UPDATE_PRICINGDETAILS = 'TEMP_LISTING_UPDATE_PRICINGDETAILS';
export const TEMP_LISTING_UPDATE_SPACEAVAILABLE = 'TEMP_LISTING_UPDATE_SPACEAVAILABLE';
