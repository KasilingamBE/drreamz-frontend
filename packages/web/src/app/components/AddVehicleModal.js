...
const AddVehicleModal = ({ show, handleClose, handleSave,handleUpdate=()=>{},edit=false,id="",userId,profileType }) => {
  ...
  const onSubmitHandler = async () => {
    try {
      // if(activeIndex!=9){
        ...
        if(edit){
          handleUpdate({...vehicle, image: await saveImage(),id:id,userId:userId,profileType:profileType });
        }else{
        handleSave({ ...vehicle, image: await saveImage(),userId:userId,profileType:profileType });
        }
        // setActiveIndex(1);
        // setProgress(0);
        setVehicle({image: '',
  ...
  useEffect(()=>{
    ...
    if(edit && id){
      const getVehicleData = ()=>{
        ...
        client.query({query:GET_VEHICLE,variables:{id:id}}).then(({data})=>{
          if(data.getVehicle){
  ...
  return (
    ...
    {/* } */}
    {/* {activeIndex==3 && */}
     <div className="question-item"><h4 className="heading">Your Vehicle's Make</h4>
          <Form.Group controlId='formBasicEmail'>
            <Form.Control
              type='text'
              name='make'
            ...
            {/* {activeIndex==4 &&  */}
            <div className="question-item"><h4 className="heading">Your Vehicle's Model</h4>
...
{/* {activeIndex==5 &&  */}
<div className="question-item"><h4 className="heading">Your Vehicle's Year</h4>
          ...
          <div className="question-item"><h4 className="heading">Choose your Vehicle Size</h4>
          <Form.Group controlId='exampleForm.SelectCustom'>
            <Form.Control
              as='select'
              name='size'
          ...
          {/* {activeIndex==7 &&  */}
            <div className="question-item"><h4 className="heading">Tell us your vehicle color</h4>
          ...
          {/* {activeIndex==8 &&  */}
          <div className="question-item">
            <h4 class="heading">Add Photo of your Vehicle</h4>
            <Form.File
            name='image'
