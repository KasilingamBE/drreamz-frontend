...
const ChatBox = (props) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      console.log(data.getDriverOwnerMessagesByListingId);
      // let msg = data.getDriverOwnerMessagesByListingId[0];
      // if(msg.senderId===ownerId){
      //   setDriver({name:msg.recieverName,id:msg.recieverId});
      // }else{
      //   setDriver({name:msg.senderName,id:msg.senderId});
      // }
  ...
  if (!props.authenticated)
    return <h3 className="text-center">Please signin to access this page</h3>;
  return (
    <div>
      {/* <div>
        <Alert variant="primary">
          <h3 className="pb-0 mb-0 text-center">Parkyourself Group Chat</h3>
        </Alert>
      </div> */}
