...
const SpaceOwnerProfileModal = ({ show, handleClose, handleSave,handleUpdate,edit,spaceOwnerProfile,userId }) => {
  ...
  const onSubmitHandler = async () => {
    try {
      if(activeIndex!=6){
        if ((activeIndex==1 && address) ||(activeIndex==2) || (activeIndex==3) || (activeIndex==4) || (activeIndex==5)) { 
          setActiveIndex(activeIndex+1);
          setProgress(progress+20);
          setValidated(false);
        } else {
        ...
        if(edit){
          handleUpdate({...spaceOwnerData,id:spaceOwnerProfile.data._id,userId:userId });
        }else{
  ...
  useEffect(()=>{
    ...
    if(edit){
      const getSpaceOwnerData = ()=>{
        const {address,businessName,facebook,twitter,instagram} = spaceOwnerProfile.data;
  ...
  return (
    <Modal show={show} onHide={onCloseHandler} className="spaceowner-profile-modal">
      <Modal.Header closeButton>
        <Modal.Title>{edit?"Edit Space Owner Profile":"Create Space Owner Profile"}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
      <ProgressBar now={progress} />
        <Form validated={validated} className="vehicle-form">
          
          {activeIndex==1 && <div className="question-item">
          ...
          <PlacesAutocomplete
              ...
              This field is required
                      ...
                      <div className="input-group-append location-btn" onClick={()=>{getCurrentLocation()}}>
                        <span className="input-group-text"><BiCurrentLocation /></span>
                      </div>
                      </div>
    ...
    {activeIndex==2 && <div className="question-item">
    ...
    {activeIndex==3 && <div className="question-item"><h4 className="heading">Do you have a Facebook account?</h4>
    <Form.Group controlId='formBasicEmail'>
            <Form.Control
              type='text'
              name='facebook'
            ...
            {activeIndex==4 && <div className="question-item"><h4 className="heading">Do you have a Twitter account?</h4>
    <Form.Group controlId='formBasicEmail'>
            <Form.Control
              type='text'
              name='twitter'
            ...
            {activeIndex==5 && <div className="question-item"><h4 className="heading">Do you have a Instagram account?</h4>
    <Form.Group controlId='formBasicEmail'>
            <Form.Control
              type='text'
              name='instagram'
          ...
          {activeIndex==6 && <div className="question-item"><h4 className="heading">Save your Space Owner Profile</h4>
