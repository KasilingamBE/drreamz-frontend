      ...
      <Modal.Body>
        ...
        <div className="parking-ticket-modal">
          <div className="parking-ticket-canvas">
            <h2 className="heading">{newTicket} Parking Ticket</h2>
          ...
          <Button
            ...
            onClick={() => {
              ...
              window.scrollTo(0, 0);
              html2canvas(
                document.querySelector(".parking-ticket-canvas")
          ...
          {vehicle && (
            <>
              ...
              <WhatsappShareButton
                ...
                } | Arrive After: ${moment(new Date(start)).format(
                  "lll"
                )} | Exit Before: ${moment(new Date(end)).format("lll")}`}
              >
